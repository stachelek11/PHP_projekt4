...
<main class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="CRUD_albumy col-4">
            <span>Wszystkie zespoly z gatunkiem muzycznym "Rap"</span><br>
            <a href="FPDF/PDF_zespoly_dow.php" class="col-12 btn btn-outline-light">Pobierz</a>
            <a href="FPDF/PDF_zespoly.php" target="_blank" class="col-12 btn btn-outline-light">Wyświetl</a>
        </div>
    </div>
</main>
</body>
