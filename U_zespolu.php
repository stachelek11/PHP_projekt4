...
<main class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="CRUD_albumy create col-6 col-xl-4">
            <article>
                <form method="post" action="R_Update_zespolu.php">
                    <div class="form-group">
                        <label for="col-12 exampleTextarea">Który zespół chcesz edytować ?</label>
                        <input class="col-12 form-control" placeholder="Podaj indeks zespołu" type="number" name="zespolID">
                        <?php
                            if (isset($_SESSION['UError_zespolu'])) {
                                echo '<span class="text-danger">' . $_SESSION['UError_zespolu'] . '</span><br>';
                                unset($_SESSION['UError_zespolu']);
                            }
                        ?>
